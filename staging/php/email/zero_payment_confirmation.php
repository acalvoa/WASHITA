...
// UNCOMMENT ONLY FOR A TEST and open page  /staging/php/email/zero_payment_confirmation.php
// $order = Order::GetOrderByNumber('21120');
// echo GetZeroPaymentConfirmationBody($order);

function GetZeroPaymentConfirmationBody(Order $order){
