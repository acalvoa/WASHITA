...
class PHPMailer
{
    ...
    {
        if(!empty($address)){
            foreach(explode(",",$address) as $to){
                $isAdded = $this->addAnAddress('to', $to, $name);
                if(!$isAdded){
                    return false;
                }
            }
    ...
    {
        if(!empty($address)){
            foreach(explode(",",$address) as $cc){
                $isAdded = $this->addAnAddress('cc', $cc, $name);
                if(!$isAdded){
                    return false;
                }
            }
    ...
    public function addBCC($address, $name = '')
    {
        if(!empty($address)){
            foreach(explode(",",$address) as $bcc){
                $isAdded = $this->addAnAddress('bcc', $bcc, $name);
                if(!$isAdded){
                    return false;
                }
            }
