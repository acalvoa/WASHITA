...
$myPath
=
"/home/washita/washita/staging/transbank/comun/MAC01Normal$TBK_ID_SESION.txt";
$pathSubmit
= "http://IP_SERVIDOR/TIENDA_TEST/html/index.php";
/****************** FIN CONFIGURACION *****************/
...
$TBK_HORA_TRANSACCION[1]=substr($TBK_HORA_TRANSACCION[1],0,2).":".substr($TBK_HORA_TRANS
ACCION[1],2,2).":".substr($TBK_HORA_TRANSACCION[1],4,2);
?>
<html>
<head><title>TIENDA PHP KCC6.0.2</title></head>
<body>
...
align=left><?php
echo
$TBK_CODIGO_AUTORIZACION[1];?></td>
<th align=left>Fecha Contable:</th>
<td
align=left><?php
echo
$TBK_FECHA_CONTABLE[1];?></td>
</tr>
<tr valign=top >
<th
align=left>Fecha
...
echo
$TBK_HORA_TRANSACCION[1];?></td>
de
cr&eacute;dito:</th>
<td align=left>XXXXXXXXXXXX<?php echo
$TBK_FINAL_NUMERO_TARJETA[1];?></td>
</tr>
<tr valign=top>
<th
align=left>Tipo
