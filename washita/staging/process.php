                        ...
                        <div class="row item checkout-block">
                            ...
                            <div class="input-group-horizontal">
                                <div class="payelement">
                                    ...
                                    <div class="logofield"><img class="webpay-logo" src="img/webpayplus.jpg" height="80"></div>
                                </div>
                                <div class="payelement">
                                    <div class="inputfield"><input type="radio" name="payment_method" value="oneclick"></div> 
                                    <div class="logofield"><img class="webpay-logo" src="img/oneclick.png" height="80"></div>
                                </div>
                            </div>
                        </div>
