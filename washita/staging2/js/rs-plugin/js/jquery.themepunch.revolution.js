	...
	jQuery.fn.extend({
		...
		********************************/
		...
		function prepareSlides(container,opt) {
			...
			container.find('>ul:first').css({overflow:'auto',width:'100%',height:'100%',maxHeight:container.parent().css('maxHeight')});
			if (opt.autoHeight=="on") {
			   container.find('>ul:first').css({overflow:'auto',width:'100%',height:'100%',maxHeight:"none"});
